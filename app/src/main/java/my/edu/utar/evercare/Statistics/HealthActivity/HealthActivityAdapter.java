...
public class HealthActivityAdapter extends RecyclerView.Adapter<HealthActivityAdapter.ViewHolder> {
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView healthActivityLevelTextView;
        TextView dateTextView;

        public ViewHolder(@NonNull View itemView) {
            super(itemView);
            healthActivityLevelTextView = itemView.findViewById(R.id.healthActivityLevelTextView);
            dateTextView = itemView.findViewById(R.id.dateTextView);
        }

        public void bind(HealthActivityData healthActivityData) {
            healthActivityLevelTextView.setText(healthActivityData.getHealthActivityLevel());
