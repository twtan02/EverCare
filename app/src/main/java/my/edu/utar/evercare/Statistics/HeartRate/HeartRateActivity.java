                    ...
                    if (documentSnapshot.exists()) {
                        ...
                        if (userRole != null) {
                            ...
                            if (userRole.equals("Elderly")) {
                                ...
                                heartRateEditText.setHintTextColor(ContextCompat.getColor(this, R.color.my_red));
                                heartRateEditText.setHint("You are not allowed to edit this field.");
                            } else {
                                // Enable EditText if the current user is caregiver or staff
                                heartRateEditText.setEnabled(true);
                            }
                        } else {
