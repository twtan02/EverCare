                    ...
                    if (documentSnapshot.exists()) {
                        ...
                        if (userRole != null) {
                            ...
                            if (userRole.equals("Elderly")) {
                                ...
                                sleepDurationEditText.setEnabled(false);
                                // Optionally, change the hint text to notify the user why the EditText is disabled
                                sleepDurationEditText.setHintTextColor(ContextCompat.getColor(this, R.color.my_red));
                                sleepDurationEditText.setHint("You are not allowed to edit this field.");
                            } else {
                                // Enable EditText if the current user is caregiver or staff
                                sleepDurationEditText.setEnabled(true);
                            }
                        } else {
